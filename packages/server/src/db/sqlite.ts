...
/**
 * Der alte Speicher: SQLite unter `$DATA_DIR/abrechnung.sqlite`.
 *
 * Seit der Umstellung auf Postgres schreibt die Anwendung hier nicht mehr hin.
 * Die Klasse bleibt vorerst stehen, weil sie den Lesepfad auf den Altbestand
 * beschreibt, den `scripts/import-altbestand.mjs` uebertraegt. Erst wenn der
 * Import in der Produktion nachweislich durch ist, wird sie in einem eigenen
 * Schritt entfernt.
 *
